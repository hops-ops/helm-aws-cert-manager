...
PACKAGE ?= helm-aws-cert-manager
XRD_DIR := apis/certmanagers
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/certmanagers/standard.yaml
...
EXAMPLES := \
    examples/certmanagers/minimal.yaml:: \
    examples/certmanagers/standard.yaml::
...
render\:%:
	@example="examples/certmanagers/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
